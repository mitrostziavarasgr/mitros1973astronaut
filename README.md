...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/mitros1973astronaut
```

A live public deployment of this template is available at [https://mitros1973astronaut.templates.workers.dev](https://mitros1973astronaut.templates.workers.dev)
